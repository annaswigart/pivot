...
if (Meteor.isServer){
    ...
    Meteor.publish('careersFiltered', function(){
    	Mongo.Collection._publishCursor( Careers.find({}, { $text: { $search: {skills: this.query}}}, {sort: {num_ids: -1}}), this, 'careersFiltered'); 
    	console.log(this.query + " query done");
    	this.ready();
	});
